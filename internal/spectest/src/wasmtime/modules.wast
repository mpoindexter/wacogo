...
(assert_unlinkable
  ...
  "missing expected export `the-export`")
...
(assert_unlinkable
  ...
  "missing expected import `env::something`")
...
(assert_unlinkable
  ...
  "type mismatch: expected: (func (param i32)), found: (func)")
...
(assert_unlinkable
  ...
  "type mismatch: expected core global, found core function") ;; WACOGO: edited
...
(assert_unlinkable
  ...
  "type mismatch: expected core function, found core table") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch: expected core function, found core memory") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch: expected core function, found core global") ;; WACOGO: edited
...
(assert_unlinkable
  ...
  "type mismatch in export `f`: type mismatch: expected: (func (param i32)), found: (func)") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in export `t`: expected table element type externref, found funcref") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in export `t`: type mismatch: mismatch in table limits: table minimum size 2 greater than 1") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in export `m`: type mismatch: mismatch in memory limits: memory minimum size 2 is greater than 1") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in export `g`: expected global type f32, found i32") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in export `g`: type mismatch: global mutability mismatch, expected true, found false") ;; WACOGO: edited
...
(assert_unlinkable
  ...
  "type mismatch: expected core table, found core function") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch: expected core memory, found core function") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
...
(assert_unlinkable
  ...
  "type mismatch in import `::`: type mismatch: expected: (func), found: (func (param i32))") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in import `::`: expected table element type funcref, found externref") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in import `::`: type mismatch: mismatch in table limits: table minimum size 1 greater than 0") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in import `::`: type mismatch: mismatch in memory limits: memory minimum size 1 is greater than 0") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in import `::`: expected global type i32, found f32") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "foo" (instance
  ...
  "type mismatch in import `::`: type mismatch: global mutability mismatch, expected false, found true") ;; WACOGO: edited
