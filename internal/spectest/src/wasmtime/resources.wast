...
(assert_unlinkable
  ...
  "type mismatch: missing expected export `missing` in instance type") ;; WACOGO: edited
(assert_unlinkable
  (component
    (import "host" (instance
  ...
  "expected resource, found function") ;; WACOGO: edited
...
(assert_trap (invoke "f") "invalid table index") ;; WACOGO: edited
...
(component
  (component $inner
    ...
    (core module $m
      ...
      (func (export "alloc")
        (if (i32.ne (call $ctor (i32.const 100)) (i32.const 1)) (then (unreachable))) ;; WACOGO: edited expected table index
      )
      (func (export "dealloc")
        (call $drop (i32.const 1)) ;; WACOGO: edited table index
      )
    )
    (core instance $i (instantiate $m
      (with "" (instance
...
(component
  ...
  (component $inner
    ...
    (core module $m
      ...
      (func (export "alloc")
        (if (i32.ne (call $ctor (i32.const 100)) (i32.const 1)) (then (unreachable))) ;; WACOGO: edited table index
      )
      (func (export "dealloc")
        (call $drop (i32.const 1)) ;; WACOGO: edited table index
      )
...
(assert_return (invoke "alloc-in2"))
(assert_return (invoke "dealloc-in2"))
(assert_trap (invoke "dealloc-in2") "unknown handle index 1") ;; WACOGO: edited
...
(assert_trap (invoke "f") "cannot lift owned resource while it has active borrows") ;; WACOGO: edited
  ...
  (component $B
    ...
    (core module $m
      ...
      (func (export "f")
        ...
        (if (i32.ne (local.get $r1) (i32.const 1)) (then (unreachable))) ;; WACOGO: edited handle index
        (if (i32.ne (local.get $r2) (i32.const 2)) (then (unreachable))) ;; WACOGO: edited handle index
...
(assert_trap (invoke "drop-r1-as-r2") "resource type mismatch in canon drop") ;; WACOGO: edite
(component instance $C1 $C)
(assert_trap (invoke "return-r1-as-r2") "resource handle type mismatch during lift") ;; WACOGO: edite
